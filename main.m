...
for ObserveCount=1:ObserveCountsPerCycle
    ...
    for ExpRound=1:ExpCounts
        ...
        [ Sigma0 ] = CalculatingAveragedBackCoef( height, slope_x, slope_y, Lx, Ly, ...
            dx, dy, ObservingAngle, Conf);

        % first zero-centering the sigma and normalize it.
        [ Sigma0_Relative, Sigma0_mean ] = ZeroCenteredAndNormalization( Lx, Ly, dx, dy, ...
            RadarAltitude, IncidentAngle, Sigma0 );
